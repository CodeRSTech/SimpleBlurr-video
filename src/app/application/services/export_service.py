...
class ExportService:
    ...
    def session_is_ready_for_export(self, session_id: str) -> bool:
        ...
        return bool(session.final_frame_items_by_frame_index)
    ...
    def export_annotations_json(self, session: Session, output_path: str) -> None:
        ...
        for frame_index, items in sorted(session.final_frame_items_by_frame_index.items()):
        ...
        with open(output_path, "w", newline="", encoding="utf-8") as f:
            ...
            for frame_index, items in sorted(session.final_frame_items_by_frame_index.items()):
                for i in items:
                    ...
                    writer.writerow([
                        frame_index, i.item_id, i.source, i.label,
                        x1, y1, x2, y2,
